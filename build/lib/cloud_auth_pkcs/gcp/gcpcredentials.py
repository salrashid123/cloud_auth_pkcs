import pkcs11
from cloud_auth_pkcs.base import BaseCredential, sha256
...
class GCPCredentials(BaseCredential,credentials.CredentialsWithQuotaProject):
    ...
    def __init__(
        ...
        BaseCredential.__init__(self,module=module,token=token,label=label,pin=pin)
    ...
    def jwt_token(self,iat, exp, key_id, email, scopes):
        ...
        sig = self.sign(data=total_params)
    ...
    def _update_token(self, request):
        ...
        try:
            ...
            raise exceptions.RefreshError("Error creating GCP Token: {}".format(e))
